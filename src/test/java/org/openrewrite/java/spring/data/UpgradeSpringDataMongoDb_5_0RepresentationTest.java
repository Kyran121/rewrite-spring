          ...
          mavenProject("app",
            ...
            java(
              ...
              """
                ...
                /*~~(Spring Data MongoDB 5 requires an explicit UUID representation; configure `spring.mongodb.representation.uuid` or `MongoClientSettings.Builder.uuidRepresentation(...)`.)~~>*/@Document
                class Account {
                    private UUID externalId;
                }
                """
